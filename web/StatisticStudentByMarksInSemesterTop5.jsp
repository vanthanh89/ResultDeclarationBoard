            ...
            <div class="main_content">
                ...
                <div class="center_content">  
                    ...
                    <div class="right_content">            
                        <center>
                            <h2>Statistic top 5  Student by marks in a semester</h2>
                            <html:form action="sp_StudentByMarksInSemesterTop5">
                            ...
                            <br />
                            <div>
                                <c:if test="${not empty requestScope.resultSetTop5}">
                                    <table>
                                        <thead>
                                        ...
                                        <tbody>
                                            <%
                                                ResultSet rs = (ResultSet) request.getAttribute("resultSetTop5");
                                            %>
                                            <% while (rs.next()) { %>
                                            <tr>
