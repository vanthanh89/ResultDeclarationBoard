 ...
 * @author thanh
 */
public class UpdateMark extends org.apache.struts.action.Action {
...
//      ActionFormBean afb = (ActionFormBean)form;
          ...
          int reId = Integer.parseInt(request.getParameter("ree"));
          request.setAttribute("reEvaluation", reId);
