...
public class Marks  implements java.io.Serializable {
    ...
    public Marks(MarkId id, Student student, Subjects subjects) {
        this.id = id;
        this.student = student;
        this.subjects = subjects;
    }
    public Marks(MarkId id, Student student, Subjects subjects, Integer mark, Date testDate, String isReleased, String isPass, String reEvaluation) {
       this.id = id;
       this.student = student;
       this.subjects = subjects;
       this.mark = mark;
